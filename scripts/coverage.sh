...
#   - blackwall-client/src/{api,http}.rs   control-API/metrics-endpoint HTTP GET (reqwest) — needs a live daemon
#   - blackwall-tui/src/main.rs        terminal setup (crossterm) + the tokio refresh-loop driver
